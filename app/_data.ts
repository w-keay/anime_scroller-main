/**
 * Anime data array containing information about various anime series.
 * Each entry represents a different anime series with details such as name, image URL, type, number of episodes, episodes aired, and score.
 */
